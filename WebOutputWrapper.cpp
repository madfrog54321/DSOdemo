...
class WebOutputWrapper : public Output3DWrapper
{
public:

uWS::Hub* h;

        inline WebOutputWrapper(uWS::Hub* h)
        {
          this->h=h;
            printf("OUT: Web output wrapper started\n");
        }

        virtual ~WebOutputWrapper()
        {
        ...
        {
          /*
            std::cout << std::endl << "========== Pose Start =========" << std::endl;
            ...
            std::cout << "X: " << frame->camToWorld.matrix3x4()(0, 3) << std::endl;
